...
Examples:
  ...
  my_verisure alarm arm --mode away --no-confirm
    ...
    auth_subparsers = auth_parser.add_subparsers(dest='action', help='Authentication actions')
    ...
    info_subparsers = info_parser.add_subparsers(dest='action', help='Information actions')
    
    info_subparsers.add_parser('installations', help='List all installations')
    
    services_parser = info_subparsers.add_parser('services', help='Show installation services')
    services_parser.add_argument('--installation-id', help='Installation ID')
    
    status_parser = info_subparsers.add_parser('status', help='Show installation status')
    ...
    alarm_subparsers = alarm_parser.add_subparsers(dest='action', help='Alarm actions')
    
    status_alarm_parser = alarm_subparsers.add_parser('status', help='Show alarm status')
    status_alarm_parser.add_argument('--installation-id', help='Installation ID')
    
    arm_parser = alarm_subparsers.add_parser('arm', help='Arm the alarm')
    arm_parser.add_argument('--mode', required=True, choices=['away', 'home', 'night'], help='Arming mode')
    arm_parser.add_argument('--installation-id', help='Installation ID')
    arm_parser.add_argument('--no-confirm', action='store_true', help='Skip confirmation prompt')
    
    disarm_parser = alarm_subparsers.add_parser('disarm', help='Disarm the alarm')
    disarm_parser.add_argument('--installation-id', help='Installation ID')
    disarm_parser.add_argument('--no-confirm', action='store_true', help='Skip confirmation prompt')
