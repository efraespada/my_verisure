...
class BaseCommand(ABC):
    ...
    def get_installation_id(self, installation_id: Optional[str] = None) -> Optional[str]:
    ...
    async def select_installation_if_needed(self, installation_id: Optional[str] = None) -> Optional[str]:
        ...
        try:
            ...
            if len(installations) == 1:
                ...
                print_info(f"Usando única instalación disponible: {installation.alias}")
