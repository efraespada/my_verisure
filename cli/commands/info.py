...
class InfoCommand(BaseCommand):
    ...
    async def _show_services(self, installation_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print_info(f"Obteniendo servicios para instalación: {installation_id}")
            
            services_data = await self.installation_use_case.get_installation_services(installation_id)
    ...
    async def _show_status(self, installation_id: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print_info(f"Obteniendo estado para instalación: {installation_id}")
