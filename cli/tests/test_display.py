...
from cli.utils.display import (
    ...
    print_warning, print_command_header, print_installation_info,
    print_alarm_status, print_services_info, print_separator
)
...
class TestDisplayFunctions:
    ...
    def test_print_services_info_success(self, mock_stdout):
        ...
        # Mock services data
        class MockService:
            def __init__(self, service_id, request, active=True, visible=True, is_premium=False, bde=False):
    ...
    def test_print_services_info_failure(self, mock_stdout):
        ...
        print_services_info(services_data)
        output = mock_stdout.getvalue()
        assert "❌ Error obteniendo servicios: Error getting services" in output
