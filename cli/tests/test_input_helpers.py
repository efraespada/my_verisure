...
from cli.utils.input_helpers import (
    ...
    select_installation, confirm_action
)
...
class TestInputHelpers:
    ...
    def test_select_phone_single_phone(self, mock_input):
        ...
        assert phone_id == "1"
        mock_input.assert_called_once_with("Selecciona el número de teléfono (1, 2, ...): ")
    ...
    def test_select_installation_multiple_installations(self, mock_input):
        ...
        mock_input.assert_called_once_with("Selecciona el número de instalación (1-2): ")
