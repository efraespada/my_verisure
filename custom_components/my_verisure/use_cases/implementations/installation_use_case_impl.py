...
class InstallationInfoCache:
    ...
    def __init__(self, ttl_seconds: int = 300):  # 5 minutes default TTL
        ...
        self._cache: Dict[str, Tuple[InstallationServices, float]] = {}  # installation_id -> (services, timestamp)
    ...
    def set(self, installation_id: str, services: InstallationServices) -> None:
