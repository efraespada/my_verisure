...
class TestDependencyInjectionContainer:
    ...
    def test_get_dependency_success(self):
        ...
        # Mock the injector
        with patch('my_verisure.core.dependency_injection.container.Injector') as mock_injector_class:
            mock_injector = Mock()
...
class TestDependencyInjectionProviders:
    ...
    def test_setup_dependencies(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.MyVerisureModule') as mock_module_class:
            mock_module = Mock()
            mock_module_class.return_value = mock_module
            
            with patch('my_verisure.core.dependency_injection.providers.setup_injector') as mock_setup:
                setup_dependencies()
    ...
    def test_get_auth_use_case(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_auth_use_case):
    ...
    def test_get_installation_use_case(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_installation_use_case):
    ...
    def test_get_alarm_use_case(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_alarm_use_case):
    ...
    def test_get_get_installation_devices_use_case(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_use_case):
    ...
    def test_get_auth_client(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_auth_client):
    ...
    def test_get_installation_client(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_installation_client):
    ...
    def test_get_alarm_client(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_alarm_client):
    ...
    def test_get_camera_client(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_camera_client):
    ...
    def test_get_camera_repository(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_camera_repository):
    ...
    def test_clear_dependencies(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.clear_injector') as mock_clear:
            clear_dependencies()
    ...
    def test_provider_functions_with_injector_error(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', side_effect=RuntimeError("Injector not setup")):
    ...
    def test_setup_dependencies_with_module_error(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.MyVerisureModule', side_effect=Exception("Module error")):
    ...
    def test_provider_functions_with_dependency_error(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', side_effect=Exception("Dependency error")):
    ...
    def test_all_provider_functions(self):
        ...
        with patch('my_verisure.core.dependency_injection.providers.get_dependency', return_value=mock_dependency):
