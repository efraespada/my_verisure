...
from .models.dto.installation_dto import InstallationDTO, InstallationServicesDTO
...
class MyVerisureClientRefactored:
    ...
    async def login(self) -> AuthDTO:
        ...
        try:
            ...
            self._session_data = {
                ...
                "needDeviceAuthorization": auth_result.need_device_authorization or False,
    ...
    def is_session_valid(self) -> bool:
        ...
        return self._session_client.is_session_valid(self._session_data, self._hash)
    ...
    async def get_installation_services(self, installation_id: str, force_refresh: bool = False) -> InstallationServicesDTO:
    ...
    def clear_installation_services_cache(self, installation_id: Optional[str] = None) -> None:
        ...
        self._installation_client.clear_installation_services_cache(installation_id)
