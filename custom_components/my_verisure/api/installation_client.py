...
from .models.dto.installation_dto import InstallationDTO, InstallationServicesDTO, InstallationsListDTO
...
class InstallationClient(BaseClient):
    ...
    async def get_installations(self, hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> List[InstallationDTO]:
        ...
        try:
            ...
            # Convert to DTOs
            installation_dtos = [InstallationDTO.from_dict(inst) for inst in installations]
    ...
    async def get_installation_services(self, installation_id: str, force_refresh: bool = False,
                                      hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> InstallationServicesDTO:
