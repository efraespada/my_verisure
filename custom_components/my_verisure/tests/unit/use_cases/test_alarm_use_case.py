...
class TestAlarmUseCase:
    ...
    @pytest.mark.asyncio
    async def test_get_alarm_status_success(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_alarm_status_raises_exception(self, alarm_use_case, mock_alarm_repository):
        """Test get alarm status raises exception."""
        # Arrange
        installation_id = "12345"
        mock_alarm_repository.get_alarm_status.side_effect = MyVerisureError("Connection failed")
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_away_success(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_away_failure(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_home_success(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_home_failure(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_night_success(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_night_failure(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_disarm_alarm_success(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_disarm_alarm_failure(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_away_raises_exception(self, alarm_use_case, mock_alarm_repository):
        """Test arm alarm away raises exception."""
        # Arrange
        installation_id = "12345"
        mock_alarm_repository.arm_panel.side_effect = MyVerisureError("Connection failed")
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_home_raises_exception(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_arm_alarm_night_raises_exception(self, alarm_use_case, mock_alarm_repository):
    ...
    @pytest.mark.asyncio
    async def test_disarm_alarm_raises_exception(self, alarm_use_case, mock_alarm_repository):
        """Test disarm alarm raises exception."""
        # Arrange
        installation_id = "12345"
        mock_alarm_repository.disarm_panel.side_effect = MyVerisureError("Connection failed")
