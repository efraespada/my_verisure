...
class TestAuthUseCaseImpl:
    ...
    async def test_login_success(self):
        ...
        self.mock_auth_repository.login = AsyncMock(return_value=expected_result)
    ...
    async def test_send_otp_success(self):
        ...
        self.mock_auth_repository.send_otp.assert_called_once_with(record_id, otp_hash)
...
class TestSessionUseCaseImpl:
    ...
    async def test_load_session_success(self):
        ...
        self.mock_session_repository.load_session = AsyncMock(return_value=session_data)
        ...
        self.mock_session_repository.load_session.assert_called_once_with(file_path)
    ...
    async def test_load_session_failure(self):
        ...
        self.mock_session_repository.load_session = AsyncMock(return_value=None)
    ...
    async def test_save_session_success(self):
        ...
        self.mock_session_repository.save_session = AsyncMock(return_value=True)
        ...
        # Assert
        assert result is True
        self.mock_session_repository.save_session.assert_called_once_with(file_path, session_data)
    ...
    def test_is_session_valid_with_data(self):
        ...
        # Assert
        assert result is True
        self.mock_session_repository.is_session_valid.assert_called_once_with(session_data)
...
class TestInstallationUseCaseImpl:
    ...
    def setup_method(self):
        ...
        self.use_case = InstallationUseCaseImpl(self.mock_installation_repository)
    ...
    async def test_get_installations_success(self):
        ...
        self.mock_installation_repository.get_installations = AsyncMock(return_value=installations)
    ...
    async def test_get_installation_services_success(self):
        ...
        self.mock_installation_repository.get_installation_services = AsyncMock(return_value=services)
        ...
        self.mock_installation_repository.get_installation_services.assert_called_once_with(installation_id, False)
    ...
    async def test_get_installation_services_force_refresh(self):
        ...
        # Act
        result = await self.use_case.get_installation_services(installation_id, force_refresh)
        
        # Assert
        assert result.success is True
        
        self.mock_installation_repository.get_installation_services.assert_called_once_with(installation_id, True)
    ...
    def test_get_cache_info(self):
        ...
        self.mock_installation_repository.get_cache_info.return_value = cache_info
    ...
    def test_clear_cache(self):
        ...
        # Assert
        self.mock_installation_repository.clear_cache.assert_called_once_with(installation_id)
    ...
    def test_set_cache_ttl(self):
        ...
        # Assert
        self.mock_installation_repository.set_cache_ttl.assert_called_once_with(ttl_seconds)
...
class TestAlarmUseCaseImpl:
    ...
    async def test_get_alarm_status_success(self):
        ...
        self.mock_alarm_repository.get_alarm_status = AsyncMock(return_value=alarm_status)
    ...
    async def test_arm_away_success(self):
        ...
        arm_result = ArmResult(
            success=True,
            message="Alarm armed successfully with request ARM1"
        )
        
        self.mock_alarm_repository.arm_panel = AsyncMock(return_value=arm_result)
    ...
    async def test_arm_home_success(self):
        ...
        arm_result = ArmResult(
            success=True,
            message="Alarm armed successfully with request PERI1"
        )
    ...
    async def test_disarm_success(self):
        ...
        self.mock_alarm_repository.disarm_panel = AsyncMock(return_value=disarm_result)
    ...
    async def test_disarm_failure(self):
        ...
        disarm_result = DisarmResult(
            success=False,
            message="Failed to disarm alarm"
        )
