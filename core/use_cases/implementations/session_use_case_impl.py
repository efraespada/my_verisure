...
class SessionUseCaseImpl(SessionUseCase):
    ...
    async def load_session(self, file_path: str) -> bool:
        ...
        try:
            ...
            session_data = await self.session_repository.load_session(file_path)
    ...
    async def save_session(self, file_path: str) -> bool:
        ...
        try:
            ...
            result = await self.session_repository.save_session(file_path, self._current_session_data)
    ...
    def is_session_valid(self) -> bool:
        ...
        try:
            ...
            result = self.session_repository.is_session_valid(self._current_session_data)
