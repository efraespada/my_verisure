...
class AlarmClient(BaseClient):
    ...
    async def get_alarm_status(self, installation_id: str, capabilities: str,
                             hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                check_alarm_result = await self._execute_check_alarm_direct(installation_id, panel, capabilities, hash_token, session_data)
    ...
    async def _get_real_time_alarm_status(self, numinst: str, panel: str, id_service: str, reference_id: str, capabilities: str,
                                        hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> str:
    ...
    async def send_alarm_command(self, installation_id: str, request: str, current_status: str = "E",
                               hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def disarm_alarm(self, installation_id: str, hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def arm_alarm_away(self, installation_id: str, hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> bool:
        """Arm the alarm in away mode for the specified installation."""
        return await self.send_alarm_command(installation_id, "ARM1", hash_token=hash_token, session_data=session_data)
    
    async def arm_alarm_home(self, installation_id: str, hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> bool:
        """Arm the alarm in home mode for the specified installation."""
        return await self.send_alarm_command(installation_id, "PERI1", hash_token=hash_token, session_data=session_data)
    
    async def arm_alarm_night(self, installation_id: str, hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> bool:
        """Arm the alarm in night mode for the specified installation."""
        return await self.send_alarm_command(installation_id, "ARMNIGHT1", hash_token=hash_token, session_data=session_data)
    
    # Helper methods for direct GraphQL execution
    async def _execute_check_alarm_direct(self, installation_id: str, panel: str, capabilities: str,
                                        hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            headers = self._get_session_headers(session_data or {}, hash_token) if session_data else None
            ...
            result = await self._execute_query_direct(
                CHECK_ALARM_QUERY.loc.source.body,
                variables,
                headers
            )
    ...
    async def _execute_alarm_status_check_direct(self, installation_id: str, panel: str, id_service: str, reference_id: str, capabilities: str,
                                               hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make direct request
            result = await self._execute_query_direct(
                CHECK_ALARM_STATUS_QUERY.loc.source.body,
                variables,
                headers
            )
    ...
    async def _execute_arm_panel_direct(self, installation_id: str, panel: str, request: str, current_status: str = "E", capabilities: str = "",
                                      hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make direct request
            result = await self._execute_query_direct(
                ARM_PANEL_MUTATION.loc.source.body,
                variables,
                headers
            )
    ...
    async def _execute_arm_status_direct(self, installation_id: str, panel: str, request: str, reference_id: str, counter: int, capabilities: str = "",
                                       hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make direct request
            result = await self._execute_query_direct(
                ARM_STATUS_QUERY.loc.source.body,
                variables,
                headers
            )
    ...
    async def _execute_disarm_panel_direct(self, installation_id: str, panel: str, request: str, capabilities: str = "",
                                         hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make direct request
            result = await self._execute_query_direct(
                DISARM_PANEL_MUTATION.loc.source.body,
                variables,
                headers
            )
    ...
    async def _execute_disarm_status_direct(self, installation_id: str, panel: str, request: str, reference_id: str, counter: int, capabilities: str = "",
                                          hash_token: Optional[str] = None, session_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make direct request
            result = await self._execute_query_direct(
                DISARM_STATUS_QUERY.loc.source.body,
                variables,
                headers
            )
