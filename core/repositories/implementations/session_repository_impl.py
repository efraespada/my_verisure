...
class SessionRepositoryImpl(SessionRepository):
        ...
        try:
            ...
            if result:
                ...
                if self.client._device_identifiers:
                    ...
                    device_dto = DeviceIdentifiersDTO.from_dict(self.client._device_identifiers)
                    session_data.device_identifiers = DeviceIdentifiers.from_dto(device_dto)
    ...
    async def save_session(self, file_path: str, session_data: SessionData) -> bool:
        ...
        try:
            ...
            if session_data.device_identifiers:
                self.client._device_identifiers = session_data.device_identifiers.to_dto().to_dict()
    ...
    def is_session_valid(self, session_data: SessionData) -> bool:
        ...
        try:
            ...
            _LOGGER.debug("Session appears valid (age: %d seconds)", session_age)
            return True
